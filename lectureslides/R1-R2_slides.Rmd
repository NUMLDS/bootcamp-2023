...
All of our materials are available at [github.com/msia/bootcamp-2023](https://www.github.com/msia/bootcamp-2023). Today, you will only need to work with two files, which are in the ZIP file linked at the top of the Github page.

Starting with the R3 session tomorrow, you will be working with a much wider set of files. Tomorrow, you will learn how to make a copy of the whole bootcamp-2023 repository using Git.
